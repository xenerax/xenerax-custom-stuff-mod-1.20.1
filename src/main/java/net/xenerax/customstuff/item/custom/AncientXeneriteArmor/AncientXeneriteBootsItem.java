...
public class AncientXeneriteBootsItem extends ArmorItem {
    private static final UUID HEALTH_MODIFIER = UUID.fromString("4c301ab4-6abe-11ee-b962-0242ac120002");

    public AncientXeneriteBootsItem(ArmorMaterial material, Type type, Settings settings) {
