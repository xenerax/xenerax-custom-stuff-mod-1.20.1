...
public class AncientXeneriteHelmetItem extends ArmorItem {
    private static final UUID HEALTH_MODIFIER = UUID.fromString("0a108754-6abe-11ee-b962-0242ac120002");

    public AncientXeneriteHelmetItem(ArmorMaterial material, Type type, Settings settings) {
