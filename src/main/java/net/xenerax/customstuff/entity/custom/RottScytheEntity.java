package net.xenerax.customstuff.entity.custom;
...
public class RottScytheEntity extends PersistentProjectileEntity {
    ...
    private ItemStack scytheStack = new ItemStack(ModItems.ROTT_SCYTHE);
    private boolean dealtDamage;
    public int returnTimer;


    public RottScytheEntity(EntityType<? extends RottScytheEntity> entityType, World world) {
        super((EntityType<? extends PersistentProjectileEntity>) entityType, world);
    }
    public RottScytheEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntitys.ROTTSCYTHE, owner, world);
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        this.dealtDamage = true;
        SoundEvent soundEvent = SoundEvents.ENTITY_SPIDER_AMBIENT;
    ...
    public boolean hasChanneling() {
        return EnchantmentHelper.hasChanneling(this.scytheStack);
    }
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("Trident", NbtElement.COMPOUND_TYPE)) {
            this.scytheStack = ItemStack.fromNbt(nbt.getCompound("Trident"));
        }
        this.dealtDamage = nbt.getBoolean("DealtDamage");
        this.dataTracker.set(LOYALTY, (byte)EnchantmentHelper.getLoyalty(this.scytheStack));
    }

    @Override
    public void writeCustomDataToNbt(NbtCompound nbt) {
        super.writeCustomDataToNbt(nbt);
        nbt.put("Trident", this.scytheStack.writeNbt(new NbtCompound()));
